...
module System.Taffybar.Widget.NetworkGraphWithTooltip where
...
networkGraphNewWithTooltip :: GraphConfig -> Maybe [String] -> TaffyIO GI.Gtk.Widget
networkGraphNewWithTooltip config interfaces = do
